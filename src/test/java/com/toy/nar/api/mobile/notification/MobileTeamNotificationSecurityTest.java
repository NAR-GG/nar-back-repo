...
@WebMvcTest(MobileTeamNotificationController.class)
@ContextConfiguration(classes = {
		MobileTeamNotificationController.class,
...
class MobileTeamNotificationSecurityTest {
	...
	@Test
	void rejectsUnauthenticatedNotificationSettingsRequest() throws Exception {
		int status = mockMvc.perform(get("/api/mobile/me/notification-subscriptions"))
				.andReturn()
				.getResponse()
				.getStatus();
